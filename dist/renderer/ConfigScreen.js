...
const ConfigScreen = ({ onSave, initialConfig, isValidating }) => {
    ...
    const [mode, setMode] = (0, react_1.useState)(initialConfig?.mode || 'auto');
    const [showApiKey, setShowApiKey] = (0, react_1.useState)(false);
    const handleSubmit = (e) => {
        e.preventDefault();
        onSave({ apiKey: apiKey.trim(), language, mode });
    };
            ...
            react_1.default.createElement("form", { onSubmit: handleSubmit },
                react_1.default.createElement("div", { className: "form-group" },
                    ...
                    react_1.default.createElement("div", { className: "api-key-input" },
                        react_1.default.createElement("input", { type: showApiKey ? "text" : "password", id: "apiKey", value: apiKey, onChange: (e) => setApiKey(e.target.value), required: true, placeholder: "AIza...", spellCheck: "false", autoComplete: "off" }),
                ...
                react_1.default.createElement("div", { className: "form-group" },
                    react_1.default.createElement("label", { htmlFor: "mode" }, "Mode"),
                    react_1.default.createElement("select", { id: "mode", value: mode, onChange: (e) => setMode(e.target.value), required: true },
                        react_1.default.createElement("option", { value: "auto" }, "Auto Detect"),
                        react_1.default.createElement("option", { value: "coding" }, "Coding Only"),
                        react_1.default.createElement("option", { value: "mcq" }, "MCQ Only"))),
                react_1.default.createElement("div", { className: "form-actions" },
                    react_1.default.createElement("button", { type: "submit", className: "save-button", disabled: isValidating }, isValidating ? 'Validating...' : 'Save Configuration'))))));
};
